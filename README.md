...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19703489.svg)](https://doi.org/10.5281/zenodo.19703489)
...
The package enables exact reconstruction of the core downstream numeric tables, figures, and sensitivity diagnostics (Tables 3–5, Figs. 2–5, Supplementary Tables S8–S9) from the released adjudicated dataset. It does not provide deterministic replay of the upstream retrieval, screening, or consensus-adjudication workflow.
...
- CPC bridging centrality rankings (top 10 codes)
