...
def main():
    ...
    md.append("")
    md.append("Note: the audit-only rescue record is excluded from both computations.")
    md.append("")
    ...
    md.append("Generated by `scripts/sensitivity_checks.py` from the released "
              "`data/phase2_453_families.json` and `data/decision_ledger.csv`.")
    md.append("")
    ...
    print(f"  Audit-only rescue record excluded from both computations.")
    print()
