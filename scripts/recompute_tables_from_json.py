...
Purpose:
    ...
    in the manuscript (main analytical accounting and rule-to-adjudicated diagnostic outputs; body Figure 2/3 aggregation
    ...
    decision_ledger.csv. It then cross-checks them against the
...
def main():
    ...
    print()
    print("NOTE: ITC metrics (main analytical accounting and rule-to-adjudicated")
