...
| Excluded (9 false-match + 1 screening-log-only) | 10 |
...
Note: the below-threshold screening-log record is excluded from both computations.
...
---
Generated by `scripts/sensitivity_checks.py` from the released `data/phase2_453_families.json` and `data/assignment_table.csv`.
